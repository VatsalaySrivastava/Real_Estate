					...
					<div class="propertie-item set-bg" data-setbg="img/propertie/1.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								...
								<p><i class="fa fa-map-marker"></i> Bandra Hills, Mumbai 14626</p>
							</div>
							<div class="price">Rs97,77,000</div>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/2.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								...
								<p><i class="fa fa-map-marker"></i> Lucknow,UP 23441</p>
							</div>
							<div class="price">RS 52,55/month</div>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/3.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								...
								<p><i class="fa fa-map-marker"></i> Huda City,New Delhi 33141</p>
							</div>
							<div class="price">Rs15,00,000</div>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/4.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								...
								<p><i class="fa fa-map-marker"></i> Beverly Hills,Rajasthan 90210</p>
							</div>
							<div class="price">Rs 13,000/month</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">Rs15,600/month</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 blog-item">
					...
					<h5><a href="single-blog.py">Housing confidence hits record high as prices skyrocket</a></h5>
					<div class="blog-meta">
				...
				<div class="col-lg-4 col-md-6 blog-item">
					...
					<h5><a href="single-blog.py">Taylor Swift is selling her $2.95 million Beverly Hills mansion</a></h5>
					<div class="blog-meta">
						<span><i class="fa fa-user"></i>Amanda Seyfried</span>
						<span><i class="fa fa-clock-o"></i>25 Jun 201</span>
					</div>
				...
				<div class="col-lg-4 col-md-6 blog-item">
					...
					<h5><a href="single-blog.py">NYC luxury housing market saturated with inventory, says celebrity realtor</a></h5>
					<div class="blog-meta">
						<span><i class="fa fa-user"></i>Amanda Seyfried</span>
						<span><i class="fa fa-clock-o"></i>25 Jun 201</span>
					</div>
