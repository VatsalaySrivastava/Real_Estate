            ...
            <div class="row">
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                        ...
                        <form  action="regisdbb.py" method="GET">
                            <div class="form-group">
                            	
                                <input class="form-control" placeholder="NUMBER OF ROOMS(MAX 10)" name="p1"  required>
                            </div>
                            <div class="form-group">
                                <input type="name" class="form-control"  placeholder="PLOT AREA(1 TO 10 IN 1000sq. feet)"  name="p2" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="NEAR LOCOMOTIVE(1 TO 4KMS)" name="p3" required>
                            </div>
                         
                            <div class="form-group">
                                <input  type="text" class="form-control"  placeholder="HOUSE FACING" name="p4" required>
                            </div>
                            <div class="form-group">
                                <input  type="text" class="form-control"  placeholder="NEAREST MARKETPLACE(1 TO 10KMS)" name="p5" required>
                            </div>
